...
export const ConferenceSessionsList =[
   ...
   {
  key: 1,
  title: 'Emerging Technologies for Sustainable Development',
  sessionsList: [
    'AI, ML, IoT, Robotics, Big Data, Digital Twins, Industry 4.0/5.0',
    'Emerging Materials and Disruptive Technologies',
...
{
  key: 2,
  title: 'Renewable Energy & Clean Energy Technologies',
  sessionsList: [
    'Solar, Wind, Biomass, Hydrogen, Fuel Cells',
...
{
  key: 3,
  title: 'Environmental Protection, Climate Change & Sustainability',
  sessionsList: [
...
{
  key: 4,
  title: 'Circular Economy, Waste Management & Sustainable Manufacturing',
  sessionsList: [
    'Circular Economy and Resource Efficiency',
    'Waste-to-Energy and Recycling',
    'E-Waste and Plastic-Waste Management',
    'Green Manufacturing and Eco-Design'
  ]
},

{
  key: 5,
  title: 'Technology-Enhanced Learning for International Students',
  sessionsList: [
    'AI and Digital Technologies in International Education',
    'Digital Learning Experiences of International Students',
    'Online/Hybrid Education Across Borders',
    'Digital Inclusion and Technology Access',
    'Generative AI and International Student Learning'
  ]
},

{
  key: 6,
  title: 'Engineering Education, STEM & Education for Sustainable Development',
  sessionsList: [
    'Sustainability in Engineering Curricula',
    'STEM/STEAM Education',
    'Renewable-Energy and Green-Engineering Education',
    'Digital and AI-Enabled Education'
  ]
},

{
  key: 7,
  title: 'Sustainable Management & Innovation',
  sessionsList: [
...
{
  key: 8,
  title: 'SDGs, Policy, Governance & Sustainable Futures',
  sessionsList: [
    'SDG Implementation and Monitoring',
    'Sustainability Policy and Governance',
    'Green Finance and Public Policy',
...
export const GuestList = [
    ...
    // },
    {
        ...
        GuestList: [
            ...
            {
                key:6,
                image:'/assets/images/ICETS/Leo.png',
...
'Prof. (Dr.) Alvaro Rocha, Universidade Lusófona - Centro Universitário Portugal',
